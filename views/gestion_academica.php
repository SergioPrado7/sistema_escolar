                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover align-middle">
                                        ...
                                        <tbody>
                                            ...
                                            <?php else: ?>
                                                <tr>
                                                    <td colspan="7" class="text-center text-muted">Aún no hay grupos configurados.</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover align-middle">
                                        ...
                                        <tbody>
                                            ...
                                            <?php else: ?>
                                                <tr>
                                                    <td colspan="5" class="text-center text-muted py-5">No hay periodos escolares registrados.</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
