                                            ...
                                            <?php if (count($materias_inscritas) > 0): ?>
                                                <?php foreach ($materias_inscritas as $materia): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <a href="../controllers/eliminar_carga.php?id_carga=<?php echo $materia['id_carga']; ?>&matricula=<?php echo urlencode($alumno_encontrado['matricula']); ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('¿Seguro que deseas eliminar esta materia del alumno?');"><i class="bi bi-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php else: ?>
                                ...
                                <tbody>
                                    <?php if (count($horarios_activos) > 0): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="../controllers/eliminar_horario.php?id=<?php echo $horario['id_horario']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('¿Seguro que deseas eliminar este grupo?');"><i class="bi bi-trash"></i></a></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="../controllers/eliminar_materia.php?id=<?php echo $mat['id_materia']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('¿Seguro que deseas eliminar esta materia del catálogo?');"><i class="bi bi-trash"></i></a></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../controllers/eliminar_periodo.php?id=<?php echo $per['id_periodo']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('¿Seguro que deseas eliminar este ciclo escolar?');"><i class="bi bi-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="../controllers/guardar_periodo.php" method="POST">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="fw-bold">Código del Periodo</label>
                            <input type="text" name="codigo_periodo" class="form-control" placeholder="Ej. 2026-1" required>
                        </div>
                        
                        <div class="mb-3">
                            <label class="fw-bold">Nombre del Periodo</label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" class="btn btn-vino">Guardar Periodo</button>
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal fade" id="modalNuevoGrupo" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="../controllers/guardar_grupo.php" method="POST">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="fw-bold">Periodo Escolar</label>
                        ...
                        <div class="mb-3">
                            <label class="fw-bold">Profesor Asignado</label>
                        ...
                        <div class="mb-3">
                            <label class="fw-bold">Cupo Máximo</label>
                            <input type="number" name="cupo_maximo" class="form-control" value="30" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" class="btn btn-vino">Abrir Grupo</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // 2. Cada vez que le piques a una pestaña nueva, la guardamos en la memoria secreta
