...
<body>
    ...
    <div class="hoja">
        ...
        <table class="info-tabla">
            <tr>
                <td><strong>Materia:</strong> <?php echo htmlspecialchars($info_grupo['nombre_materia']); ?></td>
                <td><strong>Grupo:</strong> <?php echo htmlspecialchars($info_grupo['nombre_grupo']); ?></td>
            </tr>
            <tr>
                <td><strong>Profesor:</strong> <?php echo htmlspecialchars($info_grupo['nombre'] . ' ' . $info_grupo['apellido_paterno']); ?></td>
                <td><strong>Periodo:</strong> <?php echo htmlspecialchars($info_grupo['nombre_periodo'] ?? 'N/A'); ?></td>
            </tr>
        </table>
            ...
            <tbody>
                ...
                foreach ($alumnos as $al): ?>
                    <tr>
                        ...
                        <td><?php echo $al['u1'] ?? '-'; ?></td>
                        <td><?php echo $al['u2'] ?? '-'; ?></td>
                        <td><?php echo $al['u3'] ?? '-'; ?></td>
                        <td><?php echo $al['u4'] ?? '-'; ?></td>
                        <td><?php echo $al['u5'] ?? '-'; ?></td>
                        <td><?php echo $al['u6'] ?? '-'; ?></td>
