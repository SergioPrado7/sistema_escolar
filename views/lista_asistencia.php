...
// Solo Profesores y Administradores pueden imprimir listas
...
// 1. OBTENER INFORMACIÓN DEL GRUPO Y MATERIA
...
// 2. OBTENER ALUMNOS INSCRITOS ORDENADOS ALFABÉTICAMENTE
...
// Cantidad de columnas en blanco para que el profe ponga asistencias (puedes ajustar el número)
$dias_asistencia = 15; 
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <style>
        ...
        .header-asistencia { border-bottom: 2px solid var(--rojo-vino); padding-bottom: 15px; margin-bottom: 20px; }
        .logo-tec { max-height: 70px; }
        ...
        .tabla-asistencia th { background-color: #f0f0f0 !important; text-align: center; }
        
        .col-dia { width: 30px; } /* Ancho de los cuadritos de asistencia */
        
        @media print {
            @page { size: landscape; margin: 1cm; } /* Fuerza la impresión en horizontal para que quepan los días */
